-- The SQL code implements the database design and each entities have at least 10 rows.
-- Used insert script and stored procedures to create data for each entity
-- The 19 entities in our database includes precise data types all the primary and foreign keys are implemented 
-- Created 6 views that span multiple tables and used for ease of lookup since our database houses a large volume of tables and data.
...
-- Created a backup of our database in the server to prevent downtime

--------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------

-- NOTE: Auto-incremented columns (PK, FK) that are referred in multiple tables, deleting a record might interefere with the referenced records.
